const experiencesData = [
    {
        ...
        responsibilities: [
            ...
            "Work on tools that interface with LLMs (both open-source and API-based)",
            "Build useful internal tools to increase delivery speed and product quality",
            "Implement and improve data pipelines for AI systems",
